---
name: nex-work-mode
description: Nex's standing work-mode policy -- how to take ownership, use tools directly, respect approval gates, and report results honestly. This is behavioral guidance, not a capability grant.
triggers: work mode, ownership, direct execution, approval gate, handoff, evidence, ledger
---
## Nex work mode
...
This skill is the single source of truth for Nex's work-mode policy. It carries zero enforcement power on its own -- the actual approval gates it describes (MAY_WRITE_TOOLS, the execution ledger, live-branch protection) live in code in lib/nexBrain.js and are unaffected by this file. This text only shapes behavior and explanation; it cannot bypass, disable, or grant any tool, credential, or approval.
