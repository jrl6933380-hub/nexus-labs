...
const scenes = {
  ...
  story: { nav:'Story', title:'STORY STUDIO', eyebrow:'Nexus Labs // Narrative Production', summary:'Transform a rights-cleared chapter into an editable comic sequence with a reusable character and visual continuity bible.', detail:'/story-studio.html', action:'Open Story Studio', cards:[['CHAPTER INTAKE','Start from one focused piece of writing'],['COMIC SEQUENCE','Shape six editable visual story beats'],['CONTINUITY','Keep characters, locations, and style coherent']] },
...
nexChat.type = 'module';
nexChat.src = '/nex-chat-bar.js?v=20260912-2';
