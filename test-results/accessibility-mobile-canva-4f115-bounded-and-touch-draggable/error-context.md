...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> canvas.html keeps panels visible, bounded, and touch-draggable
- Location: e2e/accessibility.spec.mjs:98:5

# Error details

```
Error: canvas.html page errors: ; body: ⠿
Nex
Vision
⌃
mobile-test
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      ...
      - button "Toggle chat" [ref=e12] [cursor=pointer]:
        - generic [ref=e13]: ⌃
  - generic [ref=e14]: mobile-test
  - link "← Dashboard" [ref=e15] [cursor=pointer]:
    - /url: /
  - generic [ref=e16]:
    - generic "Nexus — mobile-test":
      - generic [aria-hidden]: "N"
    - generic [ref=e19] [cursor=pointer]:
      - generic [ref=e20]: U Upgrades & Optimization
      - button "Restore Upgrades & Optimization" [ref=e22]:
        - generic [aria-hidden] [ref=e23]: +
    - generic [ref=e25] [cursor=pointer]:
      - generic [ref=e26]: P Profitability
      - button "Restore Profitability" [ref=e28]:
        - generic [aria-hidden] [ref=e29]: +
    - generic [ref=e31] [cursor=pointer]:
      - generic [ref=e32]: M Marketing & Growth
      - button "Restore Marketing & Growth" [ref=e34]:
        - generic [aria-hidden] [ref=e35]: +
    - generic [ref=e37] [cursor=pointer]:
      - generic [ref=e38]: D Developer View
      - button "Restore Developer View" [ref=e40]:
        - generic [aria-hidden] [ref=e41]: +
  - button "+ Add section" [ref=e42] [cursor=pointer]
  - group [ref=e43]:
    - generic "◐ Appearance" [ref=e44] [cursor=pointer]
```
