...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> connectors.html keeps panels visible, bounded, and touch-draggable
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      ...
      - button "Toggle chat" [ref=e12] [cursor=pointer]:
        - generic [ref=e13]: ⌃
  - generic [ref=e14]: Connector Bay
  - link "← Dashboard" [ref=e15] [cursor=pointer]:
    - /url: /
  - generic [ref=e16]:
    - generic "Nexus — Connector Bay":
      - generic [aria-hidden]: "N"
    - generic [ref=e19]:
      - generic [ref=e20]: C Connectors
      - button "Restore Connectors" [ref=e22] [cursor=pointer]:
