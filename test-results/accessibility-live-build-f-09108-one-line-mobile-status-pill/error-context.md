...
- Name: accessibility.spec.mjs >> live build feedback stays a one-line mobile status pill
- Location: e2e/accessibility.spec.mjs:217:1
...
Locator: locator('.nexus-build-feedback')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.nexus-build-feedback') with timeout 5000ms
  - waiting for locator('.nexus-build-feedback')
