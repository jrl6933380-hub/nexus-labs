...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> index.html keeps panels visible, bounded, and touch-draggable
- Location: e2e/accessibility.spec.mjs:98:5

# Error details

```
Error: index.html page errors: ; body: ⠿
Nex
Vision
⌃
N
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e17] [cursor=pointer]:
      ...
      - button "Restore Operations" [ref=e20]:
