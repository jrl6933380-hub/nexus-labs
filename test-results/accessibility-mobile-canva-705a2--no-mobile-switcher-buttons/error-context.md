...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> the Agents panel has a working touch resize grip and no mobile switcher buttons
- Location: e2e/accessibility.spec.mjs:136:3
...
Locator:  locator('.nexus-canvas-panel[data-panel-id="agent-list"]').locator('.nexus-canvas-resize-handle')
Expected: visible
Received: hidden
Timeout:  5000ms

Call log:
  - Expect "toBeVisible" locator('.nexus-canvas-panel[data-panel-id="agent-list"]').locator('.nexus-canvas-resize-handle') with timeout 5000ms
  - waiting for locator('.nexus-canvas-panel[data-panel-id="agent-list"]').locator('.nexus-canvas-resize-handle')
    14 × locator resolved to <button type="button" aria-label="Resize Agent Network" class="nexus-canvas-resize-handle"></button>
...
```yaml
- text: Nex
- button "Share the current tab visually with Nex"
- button "Toggle chat": ⌃
- text: ▥ Operations
- button "Restore Operations"
- text: ◎ Agent Network
- button "Restore Agent Network"
- text: C Command Deck
- button "Restore Command Deck"
- text: C Conference Room
- button "Restore Conference Room"
- text: F Forge Builder
- button "Restore Forge Builder"
- text: S Story Studio
- button "Restore Story Studio"
- text: M Memory Archive
- button "Restore Memory Archive"
- text: A Approval Queue
- button "Restore Approval Queue"
- text: C Connector Bay
- button "Restore Connector Bay"
- text: T Tenant Hub
- button "Restore Tenant Hub"
- text: + New Venture
- button "Restore New Venture"
- text: A All Apps
- button "Restore All Apps"
- group: ◐Appearance
```
