...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> tenants.html keeps panels visible, bounded, and touch-draggable
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      ...
      - button "Toggle chat" [ref=e12] [cursor=pointer]:
        - generic [ref=e13]: ⌃
  - generic [ref=e14]: Tenant Hub
  - link "← Dashboard" [ref=e15] [cursor=pointer]:
    - /url: /
  - generic [ref=e16]:
    - generic "Nexus — Tenant Hub":
      - generic [aria-hidden]: "N"
    - generic [ref=e19]:
      - generic [ref=e20]: N New Tenant
      - button "Restore New Tenant" [ref=e22] [cursor=pointer]:
        - generic [aria-hidden] [ref=e23]: +
    - generic [ref=e25] [cursor=pointer]:
      - generic [ref=e26]: Y Your Tenants
      - button "Restore Your Tenants" [ref=e28]:
