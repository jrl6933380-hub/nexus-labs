...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> panels can use the full phone height below the old reserved dock strip
- Location: e2e/accessibility.spec.mjs:169:3
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e17]:
      - generic [ref=e18]: ▥ Operations
      - button "Restore Operations" [ref=e20] [cursor=pointer]:
        - generic [aria-hidden] [ref=e21]: +
    - generic [ref=e23] [cursor=pointer]:
      - generic [ref=e24]: ◎ Agent Network
      - button "Restore Agent Network" [ref=e26]:
        - generic [aria-hidden] [ref=e27]: +
    - generic [ref=e29] [cursor=pointer]:
      - generic [ref=e30]: C Command Deck
      - button "Restore Command Deck" [ref=e32]:
        - generic [aria-hidden] [ref=e33]: +
    - generic [ref=e35] [cursor=pointer]:
      - generic [ref=e36]: C Conference Room
      - button "Restore Conference Room" [ref=e38]:
        - generic [aria-hidden] [ref=e39]: +
    - generic [ref=e41] [cursor=pointer]:
      - generic [ref=e42]: F Forge Builder
      - button "Restore Forge Builder" [ref=e44]:
        - generic [aria-hidden] [ref=e45]: +
    - generic [ref=e47] [cursor=pointer]:
      - generic [ref=e48]: S Story Studio
      - button "Restore Story Studio" [ref=e50]:
        - generic [aria-hidden] [ref=e51]: +
    - generic [ref=e53] [cursor=pointer]:
      - generic [ref=e54]: M Memory Archive
      - button "Restore Memory Archive" [ref=e56]:
        - generic [aria-hidden] [ref=e57]: +
    - generic [ref=e59] [cursor=pointer]:
      - generic [ref=e60]: A Approval Queue
      - button "Restore Approval Queue" [ref=e62]:
        - generic [aria-hidden] [ref=e63]: +
    - generic [ref=e65] [cursor=pointer]:
      - generic [ref=e66]: C Connector Bay
      - button "Restore Connector Bay" [ref=e68]:
        - generic [aria-hidden] [ref=e69]: +
    - generic [ref=e71] [cursor=pointer]:
      - generic [ref=e72]: T Tenant Hub
      - button "Restore Tenant Hub" [ref=e74]:
        - generic [aria-hidden] [ref=e75]: +
    - generic [ref=e77] [cursor=pointer]:
      - generic [ref=e78]: + New Venture
      - button "Restore New Venture" [ref=e80]:
        - generic [aria-hidden] [ref=e81]: +
    - generic [ref=e83] [cursor=pointer]:
      - generic [ref=e84]: A All Apps
      - button "Restore All Apps" [ref=e86]:
        - generic [aria-hidden] [ref=e87]: +
  - group [ref=e88]:
    - generic "◐Appearance" [ref=e89] [cursor=pointer]
```
