...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> memory.html keeps panels visible, bounded, and touch-draggable
- Location: e2e/accessibility.spec.mjs:98:5

# Error details

```
Error: memory.html page errors: ; body: ⠿
Nex
Vision
⌃
Memory Archive
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      ...
      - button "Toggle chat" [ref=e12] [cursor=pointer]:
        - generic [ref=e13]: ⌃
  - generic [ref=e14]: Memory Archive
  - link "← Dashboard" [ref=e15] [cursor=pointer]:
    - /url: /
  - generic [ref=e16]:
    - generic "Nexus — Memory Archive":
      - generic [aria-hidden]: "N"
    - generic [ref=e19] [cursor=pointer]:
      - generic [ref=e20]: A Add Memory
      - button "Restore Add Memory" [ref=e22]:
        - generic [aria-hidden] [ref=e23]: +
    - generic [ref=e25] [cursor=pointer]:
      - generic [ref=e26]: F Facts
      - button "Restore Facts" [ref=e28]:
        - generic [aria-hidden] [ref=e29]: +
    - generic [ref=e31] [cursor=pointer]:
      - generic [ref=e32]: P Projects
      - button "Restore Projects" [ref=e34]:
        - generic [aria-hidden] [ref=e35]: +
    - generic [ref=e37] [cursor=pointer]:
      - generic [ref=e38]: M Memory Manager
      - button "Restore Memory Manager" [ref=e40]:
