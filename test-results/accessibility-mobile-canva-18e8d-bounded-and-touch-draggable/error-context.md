...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> mission-control.html keeps panels visible, bounded, and touch-draggable
- Location: e2e/accessibility.spec.mjs:98:5

# Error details

```
Error: mission-control.html page errors: ; body: Command Deck
← Dashboard
N
Identity
+
...
Call log:
  - mission-control.html page errors: ; body: Command Deck
← Dashboard
N
Identity
+
...
+
Skills
+ locator('.nexus-canvas-panel') with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]: Command Deck
  - link "← Dashboard" [ref=e3] [cursor=pointer]:
    - /url: /
  - generic [ref=e4]:
    - generic "Nexus — Command Deck":
      - generic [aria-hidden]: "N"
    - generic [ref=e7] [cursor=pointer]:
      - generic [ref=e8]: I Identity
      - button "Restore Identity" [ref=e10]:
        - generic [aria-hidden] [ref=e11]: +
    - generic [ref=e13] [cursor=pointer]:
      - generic [ref=e14]: M Mission Chat
      - button "Restore Mission Chat" [ref=e16]:
        - generic [aria-hidden] [ref=e17]: +
    - generic [ref=e19] [cursor=pointer]:
      - generic [ref=e20]: A Approval Queue
      - button "Restore Approval Queue" [ref=e22]:
        - generic [aria-hidden] [ref=e23]: +
    - generic [ref=e25] [cursor=pointer]:
      - generic [ref=e26]: S Skills
      - button "Restore Skills" [ref=e28]:
