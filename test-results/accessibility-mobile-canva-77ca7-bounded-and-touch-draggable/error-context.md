...
- Name: accessibility.spec.mjs >> mobile canvas room interactions >> room.html keeps panels visible, bounded, and touch-draggable
...
- generic [ref=e6]:
  - generic [ref=e7]:
    - generic [ref=e8]:
      - generic [ref=e9]: Nexus Forge
      - generic [ref=e10]: AI Website & App Builder · New project
    - button "Open builder options" [ref=e12] [cursor=pointer]
  - generic [ref=e14]:
    - complementary [ref=e15]:
      - generic [ref=e16]:
        - button "Open Nex chat" [ref=e17] [cursor=pointer]: Nex
        - generic [aria-hidden] [ref=e18]: •••
    - main [ref=e19]:
      - generic [ref=e20]:
        - group "Preview size" [ref=e21]:
          - button "Fit" [pressed] [ref=e22] [cursor=pointer]
          - button "Tablet" [ref=e23] [cursor=pointer]
          - button "Phone" [ref=e24] [cursor=pointer]
        - button "Refresh" [disabled] [ref=e25] [cursor=pointer]
        - button "Open" [disabled] [ref=e26] [cursor=pointer]
      - generic [ref=e29]:
        - strong [ref=e30]: Turn your idea into a working site or app.
        - generic [ref=e31]: Describe it to Nex. He’ll build the first version, save every update, and bring in additional AI models behind the scenes when the job needs more thinking.
        - generic "Project starting points" [ref=e32]:
          - button "Business website" [ref=e33] [cursor=pointer]
          - button "Landing page" [ref=e34] [cursor=pointer]
          - button "Portfolio" [ref=e35] [cursor=pointer]
          - button "App or tool" [ref=e36] [cursor=pointer]
        - generic [ref=e37]: Describe the result you want. Nex handles the build plan.
```
