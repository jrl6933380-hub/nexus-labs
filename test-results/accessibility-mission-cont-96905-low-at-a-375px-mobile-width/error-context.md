...
- Name: accessibility.spec.mjs >> mission-control.html >> mission-control.html has no horizontal overflow at a 375px mobile width
- Location: e2e/accessibility.spec.mjs:71:5
...
- generic [active] [ref=f1e1]:
  - main [ref=f1e2]:
    ...
    - region "Nexus Forge account access" [ref=f1e7]:
      - generic [ref=f1e8]: AI Website & App Builder
      - generic [ref=f1e9]: Sign in to build with Nex.
      - generic [ref=f1e10]:
        - button "Sign in" [ref=f1e11] [cursor=pointer]
        - button "Create account" [ref=f1e12] [cursor=pointer]
      - generic [ref=f1e13]:
        - textbox "Username" [ref=f1e14]
        - textbox "Password" [ref=f1e15]
        - button "Sign in" [ref=f1e17] [cursor=pointer]
        - button "Forgot password?" [ref=f1e18] [cursor=pointer]
      - paragraph [ref=f1e19]:
        - strong [ref=f1e20]: Your work stays private to your account.
