...
export const COMIC_DIRECTOR_BIBLE_VERSION = '1.2.0';
...
export const COMIC_DIRECTOR_BIBLE = Object.freeze({
  ...
  compositionAndArt: [
    ...
    'Use architecture, sky, shadow, smoke, walls, and other quiet background shapes as deliberate lettering fields while keeping the panel visually natural.',
    'Let action and silent panels breathe. A panel does not need dialogue merely because adjacent panels have it.',
  ...
  dialogueAndLettering: [
    ...
    'Match balloon scale aggressively to the words: a one- or two-word line may use a very small balloon, while a longer exchange earns wider quiet space instead of a standard repeated box.',
    'Treat professionally lettered pages as layout lessons, not style targets: extract their negative-space use, varied balloon scale, reading flow, and protected acting without copying characters or artwork.',
