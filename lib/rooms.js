...
const FALLBACK_ROOMS = [
  ...
  // Nexus Forge IS this room -- the builder with a product name on it.
  // The slug ('room-builder') and url ('/room.html') deliberately stay
  // as they are: they're load-bearing identifiers used in stored canvas
  // state, saved panel-collapsed keys, and existing links. Only the
  // display name changes. Both old and new names stay in aliases so Nex
  // resolves either one -- "open the room builder" and "open Forge"
  // both land in the same place.
  { slug: 'room-builder', name: 'Nexus Forge', description: 'Nexus Forge \u2014 the live workbench for building and editing a custom room, site, tool, or client experience with Nex. Formerly called Room Builder; same room, product name.', url: '/room.html', aliases: ['forge', 'nexus forge', 'room builder', 'builder', 'canvas', 'live canvas', 'page builder', 'build room', 'workbench'] },
