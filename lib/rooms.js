...
const FALLBACK_ROOMS = [
  ...
  { slug: 'room-builder', name: 'Room Builder', description: 'Create and live-edit a custom room, site, tool, or client experience with Nex.', url: '/room.html', aliases: ['builder', 'canvas', 'live canvas', 'page builder', 'build room'] },
