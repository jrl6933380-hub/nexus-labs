...
// Complexity-scaled overrides layered on top of DEFAULT_BUDGETS. 'simple'
// intentionally matches DEFAULT_BUDGETS exactly (cheap conversation stays
// cheap); 'moderate' and 'complex' give real deep-task work meaningfully
// more model steps and tool calls before the loop pauses, still inside
// the hard clamps enforced by normalizeBudgets.
const COMPLEXITY_BUDGETS = Object.freeze({
  simple: Object.freeze({ maxModelSteps: 12, maxToolCalls: 24, maxToolSearches: 4, maxElapsedMs: 150_000 }),
  moderate: Object.freeze({ maxModelSteps: 20, maxToolCalls: 45, maxToolSearches: 7, maxElapsedMs: 220_000 }),
  complex: Object.freeze({ maxModelSteps: 40, maxToolCalls: 100, maxToolSearches: 14, maxElapsedMs: 360_000 }),
});
...
function normalizeBudgets(input = {}) {
  return Object.freeze({
    maxModelSteps: boundedInt(input.maxModelSteps, DEFAULT_BUDGETS.maxModelSteps, 2, 40),
    maxToolCalls: boundedInt(input.maxToolCalls, DEFAULT_BUDGETS.maxToolCalls, 1, 100),
    maxToolSearches: boundedInt(input.maxToolSearches, DEFAULT_BUDGETS.maxToolSearches, 1, 14),
    ...
    maxElapsedMs: boundedInt(input.maxElapsedMs, DEFAULT_BUDGETS.maxElapsedMs, 5_000, 360_000),
  });
}
