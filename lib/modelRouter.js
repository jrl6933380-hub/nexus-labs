...
export const DEFAULT_GATEWAY_MODELS = {
  ...
  // Keep the emergency path on a model this Gateway account can actually
  // invoke. Higher-capability models remain available through env overrides
  // once paid credits/BYOK access is configured.
  standard: 'openai/gpt-5.4-nano',
  heavy: 'openai/gpt-5.4-nano',
};
