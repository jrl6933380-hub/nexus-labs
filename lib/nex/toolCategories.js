...
export const NEX_TOOL_CATEGORIES = {
  ...
  rooms: {
    ...
    tools: ['list_rooms', 'open_room', 'render_visual', 'create_venture_canvas', 'get_ventures_overview'],
    tags: ['room', 'venture', 'canvas', 'navigate', 'open room', 'dashboard view', 'visual', 'widget', 'pinned panel', 'diagram'],
  },
  delegate: {
