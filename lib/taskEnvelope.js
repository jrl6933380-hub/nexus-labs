...
// storage migration.
//
// PORTED FROM nexus-labs-sandbox (feature/task-envelope-v2, PR #2) into
// production — this was epic task 01, previously proven only in the
// sandbox repo and never promoted here. Logic unchanged from sandbox.
