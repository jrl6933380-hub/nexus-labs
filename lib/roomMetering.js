...
export function createRoomMeter({ command = defaultRedisCommand, now = () => Date.now(), config = {} } = {}) {
  ...
  return { getUsageSummary, getDailyUsageSummary, reserveBuild, settleBuild, recordGlobalSpend, settings };
}

export { CLEANUP_SCRIPT, RESERVE_SCRIPT, SETTLE_SCRIPT, GLOBAL_SPEND_SCRIPT };
