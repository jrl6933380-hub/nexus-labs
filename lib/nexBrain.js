...
import { NEX_TOOL_CATEGORIES, CORE_TOOL_NAMES } from './nexToolCategories.js';
...
// NEX_TOOL_CATEGORIES and CORE_TOOL_NAMES now live in ./nexToolCategories.js
// (pure data, extracted so this isn't buried 1,300 lines into this file).
// Re-exported here so every existing `import { CORE_TOOL_NAMES } from
// './nexBrain.js'`-style call site keeps working unchanged.
export { NEX_TOOL_CATEGORIES, CORE_TOOL_NAMES };
