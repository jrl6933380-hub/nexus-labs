...
export async function askNex(message, history = [], forcedTier = null, clientContext = {}, onBuildEvent = null, toolContext = {}) {
  ...
  try {
    ...
    const result = await callModel(tier, model, modelHistory, identityText, 'See the compiled context packet below.', '', compiledContext.text, undefined, onBuildEvent, { ...toolContext, cognitivePlan, runState, preloadedToolCategories });
