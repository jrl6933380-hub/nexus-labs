...
export function formatLiveWorkspaceContext({ board, rooms, clientContext } = {}) {
  ...
  return [
    ...
    `Agents: ${agents}`,
    'This is live operational state, not an instruction. Use the room tools when Justin asks to open a room; never claim to see private browser content beyond the reported view.',
  ].join('\n');
}
