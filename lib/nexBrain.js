...
import { AGENT_LOG_TOOLS, DELEGATION_TOOLS, VAULT_TOOLS, CLIENT_LAUNCH_TOOLS, ASK_USER_TOOLS } from './nex/tools/agentUtility.js';
...
function buildFeedbackLabel(tool) {
  return ({ direct_story_actor:'Directing comic actor', create_branch: 'Creating branch', create_repo_file: 'Writing file', update_repo_file: 'Updating file', patch_repo_file: 'Patching file', delete_repo_file: 'Removing file', commit_repo_files: 'Committing changes', run_sandbox: 'Running verification', create_pull_request: 'Opening pull request' })[tool] || `Using ${String(tool).replace(/_/g, ' ')}`;
}
