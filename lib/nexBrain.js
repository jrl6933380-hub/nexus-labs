...
export async function askNex(message, history = [], forcedTier = null, clientContext = {}, onBuildEvent = null, toolContext = {}) {
  ...
  try {
    const result = await callModel(tier, model, modelHistory, identityText, memoriesText, snapshotContext, liveWorkspaceContext, undefined, onBuildEvent, { ...toolContext, cognitivePlan });
    return {
      reply: result.reply,
      updatedHistory,
      model: result.model,
