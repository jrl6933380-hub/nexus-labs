...
export async function askCustomerBrain({ username, body }) {
  ...
  // once, with a larger bounded budget — and, on the free tier, a different
  // model than the one that just came back empty (see freeModelPool.js).
  // Never retry paid errors or rate limits.
